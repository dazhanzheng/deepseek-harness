...
export const TYPE_API: readonly TypeApiEntry[] = [
  ...
  {
    name: 'SessionForkCloser',
    declaration: 'export type SessionForkCloser = SessionEvent<\'tool/result\'> | SessionEvent<\'step/end\'> | SessionEvent<\'turn/end\'>;',
  },
  {
  ...
  {
    name: 'SessionForkSeed',
    declaration: 'export interface SessionForkSeed {\n    readonly events: readonly SessionEvent[];\n    readonly closers: readonly SessionForkCloser[];\n    readonly inheritedEventCount: SessionLogOffset;\n}',
  },
  {
